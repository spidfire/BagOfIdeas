 ...
 * @method     ChildWikiQuery orderByName($order = Criteria::ASC) Order by the name column
 ...
 * @method     ChildWikiQuery groupByName() Group by the name column
 ...
 * @method     ChildWiki findOneByName(string $name) Return the first ChildWiki filtered by the name column
 ...
 * @method     ChildWiki requireOneByName(string $name) Return the first ChildWiki filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildWiki[]|ObjectCollection findByName(string $name) Return ChildWiki objects filtered by the name column
...
abstract class WikiQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \BagOfIdeas\Models\User\Base\WikiQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\BagOfIdeas\\Models\\User\\Wiki', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `created_at`, `updated_at` FROM `wiki` WHERE `id` = :p0';
        try {
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(WikiTableMap::COL_NAME, $name, $comparison);
    }
