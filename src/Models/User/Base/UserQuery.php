 ...
 *
 * @method     ChildUserQuery leftJoinMapPoint($relationAlias = null) Adds a LEFT JOIN clause to the query using the MapPoint relation
 * @method     ChildUserQuery rightJoinMapPoint($relationAlias = null) Adds a RIGHT JOIN clause to the query using the MapPoint relation
 * @method     ChildUserQuery innerJoinMapPoint($relationAlias = null) Adds a INNER JOIN clause to the query using the MapPoint relation
 *
 * @method     ChildUserQuery joinWithMapPoint($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the MapPoint relation
 *
 * @method     ChildUserQuery leftJoinWithMapPoint() Adds a LEFT JOIN clause and with to the query using the MapPoint relation
 * @method     ChildUserQuery rightJoinWithMapPoint() Adds a RIGHT JOIN clause and with to the query using the MapPoint relation
 * @method     ChildUserQuery innerJoinWithMapPoint() Adds a INNER JOIN clause and with to the query using the MapPoint relation
 *
 * @method     ChildUserQuery leftJoinWiki($relationAlias = null) Adds a LEFT JOIN clause to the query using the Wiki relation
 * @method     ChildUserQuery rightJoinWiki($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Wiki relation
 * @method     ChildUserQuery innerJoinWiki($relationAlias = null) Adds a INNER JOIN clause to the query using the Wiki relation
 *
 * @method     ChildUserQuery joinWithWiki($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Wiki relation
 *
 * @method     ChildUserQuery leftJoinWithWiki() Adds a LEFT JOIN clause and with to the query using the Wiki relation
 * @method     ChildUserQuery rightJoinWithWiki() Adds a RIGHT JOIN clause and with to the query using the Wiki relation
 * @method     ChildUserQuery innerJoinWithWiki() Adds a INNER JOIN clause and with to the query using the Wiki relation
 *
 * @method     \BagOfIdeas\Models\Map\MapPointQuery|\BagOfIdeas\Models\Wiki\WikiQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \BagOfIdeas\Models\User\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\BagOfIdeas\\Models\\User\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `name`, `created_at`, `updated_at` FROM `user` WHERE `id` = :p0';
        try {
    ...
    public function filterByMapPoint($mapPoint, $comparison = null)
    {
        if ($mapPoint instanceof \BagOfIdeas\Models\Map\MapPoint) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $mapPoint->getUserId(), $comparison);
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function joinMapPoint($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
     ...
     */
    public function useMapPointQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
     ...
     *
     * @param \BagOfIdeas\Models\Wiki\Wiki|ObjectCollection $wiki the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildUserQuery The current query, for fluid interface
     */
    public function filterByWiki($wiki, $comparison = null)
    {
        if ($wiki instanceof \BagOfIdeas\Models\Wiki\Wiki) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $wiki->getUserId(), $comparison);
        } elseif ($wiki instanceof ObjectCollection) {
            return $this
                ->useWikiQuery()
                ->filterByPrimaryKeys($wiki->getPrimaryKeys())
                ->endUse();
        } else {
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function joinWiki($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     */
    public function useWikiQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
