...
use BagOfIdeas\Models\User\Wiki;
use BagOfIdeas\Models\User\WikiQuery;
...
class WikiTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'User.Map.WikiTableMap';
     ...
     */
    const OM_CLASS = '\\BagOfIdeas\\Models\\User\\Wiki';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'User.Wiki';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(WikiTableMap::COL_ID, WikiTableMap::COL_NAME, WikiTableMap::COL_CREATED_AT, WikiTableMap::COL_UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(WikiTableMap::COL_ID => 0, WikiTableMap::COL_NAME => 1, WikiTableMap::COL_CREATED_AT => 2, WikiTableMap::COL_UPDATED_AT => 3, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\BagOfIdeas\\Models\\User\\Wiki');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(WikiTableMap::COL_NAME);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \BagOfIdeas\Models\User\Wiki) { // it's a model object
