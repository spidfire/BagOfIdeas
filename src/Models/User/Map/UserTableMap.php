...
namespace BagOfIdeas\Models\User\Map;
...
class UserTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\BagOfIdeas\\Models\\User\\User';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(UserTableMap::COL_ID, UserTableMap::COL_NAME, UserTableMap::COL_CREATED_AT, UserTableMap::COL_UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(UserTableMap::COL_ID => 0, UserTableMap::COL_NAME => 1, UserTableMap::COL_CREATED_AT => 2, UserTableMap::COL_UPDATED_AT => 3, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\BagOfIdeas\\Models\\User\\User');
    ...
    {
        $this->addRelation('MapPoint', '\\BagOfIdeas\\Models\\Map\\MapPoint', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
  ),
), null, null, 'MapPoints', false);
        $this->addRelation('Wiki', '\\BagOfIdeas\\Models\\Wiki\\Wiki', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
  ),
), null, null, 'Wikis', false);
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \BagOfIdeas\Models\User\User) { // it's a model object
